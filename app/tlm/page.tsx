...
const tlmPortfolioItems: PortfolioItem[] = [
  {
    id: "1",
    title: "Solar System Working Model",
    category: "Working Model",
    image: "/placeholder.jpg",
    description:
      "A fully functional solar system model with rotating planets powered by a DC motor.",
    fullDescription:
      "This project involved creating a realistic representation of the solar system. Using a DC motor and a gear system, the planets orbit the sun at different speeds. The model is built on a sturdy wooden base and features hand-painted styrofoam planets.",
    rating: 4.8,
    reviews: [
      {
        user: "Sarah J.",
        comment: "Excellent model! Helped me ace my science fair.",
        rating: 5,
      },
      {
        user: "Mike T.",
        comment: "Very detailed and sturdy. Worth the price.",
        rating: 4.5,
      },
    ],
    serviceType: "Working Model",
  },
  {
    id: "2",
    title: "Human Digestive System Chart",
    category: "Chart Work",
    image: "/placeholder.jpg",
    description:
      "Detailed and colorful chart depicting the human digestive system with labels.",
    fullDescription:
      "A large-scale chart (A1 size) illustrating the human digestive system. High-quality markers and paints were used to ensure vibrant colors and clear labels. Perfect for classroom demonstrations.",
    rating: 4.9,
    reviews: [
      {
        user: "Emily R.",
        comment: "Beautifully drawn and very informative.",
        rating: 5,
      },
    ],
    serviceType: "Chart Work",
  },
  {
    id: "3",
    ...
    image: "/placeholder.jpg",
    description:
      "A realistic volcano model made from papier-mâché with a chemical eruption feature.",
    fullDescription:
      "This classic science project features a realistic volcano structure created using papier-mâché. It includes a container for baking soda and vinegar to simulate an eruption. Great for interactive learning.",
    rating: 4.7,
    reviews: [
      {
        user: "David K.",
        comment: "The eruption effect was a hit in class!",
        rating: 5,
      },
    ],
    serviceType: "Static Model",
  },
  {
    id: "4",
    ...
    image: "/placeholder.jpg",
    description:
      "Set of 10 flashcards showing different parts of a flower with explanations.",
    fullDescription:
      "A set of durable, laminated flashcards. Each card features a high-quality illustration of a flower part (e.g., petal, stamen, pistil) on one side and a detailed description on the other.",
    rating: 4.6,
    reviews: [
      {
        user: "Jessica M.",
        comment: "Great for revision. Very durable.",
        rating: 4.5,
      },
    ],
    serviceType: "Flash Cards",
  },
];
      ...
      <main className="relative">
        ...
        <section className="relative min-h-screen flex items-center justify-center pt-20 pb-20 px-4">
          ...
          <div className="container mx-auto text-center relative z-10">
            ...
            >
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-blue-500/30 bg-blue-500/10 text-blue-500 text-sm font-medium mb-6">
